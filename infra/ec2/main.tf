...
output "ssh_connection_string_for_ec2" {
  value = format("%s%s", "ssh -i  '/Users/dares/Downloads/my-cba-project-bucket-2.pem' ubuntu@", aws_instance.jenkins_ec2_instance_ip.public_ip)
}
...
resource "aws_instance" "dev_proj_1_ec2" {
  ...
  key_name                    = "my-cba-project-bucket-2"
